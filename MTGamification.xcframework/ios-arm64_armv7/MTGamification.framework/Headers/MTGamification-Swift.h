...
#ifndef MTGAMIFICATION_SWIFT_H
#define MTGAMIFICATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MTGamification",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14MTGamification15AnimatedControl")
...
SWIFT_CLASS("_TtC14MTGamification14AnimatedButton")
...
SWIFT_CLASS("_TtC14MTGamification14AnimatedSwitch")
...
SWIFT_CLASS("_TtC14MTGamification16AnimationSubview")
...
SWIFT_CLASS("_TtC14MTGamification10LottieView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC14MTGamification13AnimationView")
...
SWIFT_CLASS("_TtC14MTGamification19CompatibleAnimation")
...
SWIFT_CLASS("_TtC14MTGamification26CompatibleAnimationKeypath")
...
SWIFT_CLASS("_TtC14MTGamification23CompatibleAnimationView")
...
SWIFT_CLASS("_TtC14MTGamification17FortuneWheelLayer")
...
SWIFT_CLASS("_TtC14MTGamification23GLScratchCardController")
@interface GLScratchCardController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC14MTGamification22GLScratchCardImageView")
@interface GLScratchCardImageView : UIImageView
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC14MTGamification17GLScratchCardView")
@interface GLScratchCardView : UIView
@property (nonatomic, weak) IBOutlet GLScratchCardImageView * _Null_unspecified scratchCardImageView;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
- (void)layoutSubviews;
@end
...
SWIFT_CLASS("_TtC14MTGamification13ScratchUIView")
...
SWIFT_PROTOCOL("_TtP14MTGamification21ScratchUIViewDelegate_")
...
SWIFT_CLASS("_TtC14MTGamification11ScratchView")
...
SWIFT_CLASS("_TtC14MTGamification14TTFortuneWheel")
...
@interface UIButton (SWIFT_EXTENSION(MTGamification))
- (void)awakeFromNib;
@end
...
@interface UIViewController (SWIFT_EXTENSION(MTGamification))
- (void)awakeFromNib;
@end
